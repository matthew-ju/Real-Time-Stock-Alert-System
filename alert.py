...
def prepare_data():
    ...
    print("Done with getting and calculating historical daily return rates from Yahoo Finance.")  # Step 1

def stock_alert_system(real_time_price):
    top_10_threshold = np.percentile(daily_returns, 90)  # Step 2
    # print("Top 10% Threshold: ", top_10_threshold)  # Step 2
    bottom_10_threshold = np.percentile(daily_returns, 10)
    # print("Bottom 10% Threshold: ", bottom_10_threshold)  # Step 2

    print("Real time price: ", real_time_price)  # Step 3
    previous_close = historical_data.iloc[-1]
    # print("Previous close: ", previous_close)  # Step 3
    return_rate = (real_time_price / previous_close - 1) * 100
    print("Return rate: ", return_rate)  # Step 3
    ...
    if return_rate >= top_10_threshold:
        ...
        print("SPY's daily return rate is within the >= top 10%. Sending a message to your phone number now.")  # Step 4
        ...
        send_sms_alert(message)
        print("SPY's daily return rate is wihin the <= bottom 10%. Sending a message to your phone number now.")  # Step 4
    ...
    plt.close()
    # print("Histogram created.")  # Step 5
